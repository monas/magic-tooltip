...
<div class='container'>
  <ul>
    <li v-for="(row, index) in dataSrc" :key="index">
      <magic-tooltip direction="bottom">
        <!-- pop up part -->
        <div slot="content" class="my-magic-tooltip-container">
          <div class="my-magic-tooltip">
            {{row.name}} <br />
  ...
  <!-- dynamic tooltip content display -->
...
export default {
  ...
  components: {MagicTooltip, MagicTooltipDisplay},
};
</script>
